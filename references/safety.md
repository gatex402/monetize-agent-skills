...
4. **Network Verification**: Double-check the network ID (e.g. `eip155:8453` for Base, `eip155:84532` for Base Sepolia) before executing withdrawals to avoid gas loss or stuck transactions.
